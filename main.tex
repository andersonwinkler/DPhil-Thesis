...
\definecolor{lightgray}{rgb}{.8, .8, .8}   % light gray
\definecolor{grey}{rgb}{.6, .6, .6}     % some grey
\definecolor{oxblue}{rgb}{0, .14510, 0.29412}
\definecolor{teddy}{rgb}{0.66275, 0.13333, 0.16863}
...
\cleardoublepage \include{05abbreviations}
\cleardoublepage \include{10intro}
\cleardoublepage \include{20ptree}
\cleardoublepage \include{30accel}
\cleardoublepage \include{40cortex}
\cleardoublepage \include{60conclusion}
\cleardoublepage \appendix
\cleardoublepage \include{80supplmat}
\cleardoublepage
\addcontentsline{toc}{chapter}{References}
\setstretch{1}
\bibliography{biblio}
\cleardoublepage \include{90finalpages}
\end{document}          
